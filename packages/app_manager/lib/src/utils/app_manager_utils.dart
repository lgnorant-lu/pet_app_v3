/*
---------------------------------------------------------------
File name:          app_manager_utils.dart
Author:             Pet App Team
Date created:       2025-07-18
Last modified:      2025-07-18
Dart Version:       3.2+
Description:        app_manager工具类和辅助函数
---------------------------------------------------------------
Change History:
    2025-07-18: Initial creation - app_manager工具类和辅助函数;
---------------------------------------------------------------
*/
...
///
/// ```dart
/// AppManagerUtils.isValidEmail("test@example.com")
/// ```
///
/// ```dart
/// AppManagerUtils.isValidPassword("password123")
/// ```
///
/// ```dart
/// AppManagerUtils.formatToTitleCase("hello world")
/// ```
///
/// ```dart
/// AppManagerUtils.formatDateTime(DateTime.now())
/// ```
///
...
///
/// ```dart
/// AppManagerValidator.isValidEmail("test@example.com")
/// ```
///
/// ```dart
/// AppManagerValidator.isValidPassword("password123")
/// ```
///
/// ```dart
/// AppManagerValidator.validateRequired("value", "字段名")
/// ```
///
class AppManagerValidator {
  /// 私有构造函数，防止实例化
  AppManagerValidator._();
...
///
/// ```dart
/// AppManagerFormatter.formatDate(DateTime.now())
/// ```
///
/// ```dart
/// AppManagerFormatter.formatFileSize(1024)
/// ```
///
/// ```dart
/// AppManagerFormatter.formatCurrency(99.99)
/// ```
///
class AppManagerFormatter {
  /// 私有构造函数，防止实例化
  AppManagerFormatter._();
...
///
/// ```dart
/// AppManagerHelper.generateId()
/// ```
///
/// ```dart
/// AppManagerHelper.debounce(() => print("执行"), Duration(seconds: 1))
/// ```
///
/// ```dart
/// AppManagerHelper.retry(() async => await someOperation(), maxAttempts: 3)
/// ```
///
...
/// String扩展方法
extension AppManagerStringExtension on String {
  /// 首字母大写
...
/// DateTime扩展方法
extension AppManagerDateTimeExtension on DateTime {
  /// 是否为今天
  bool get isToday {
    final now = DateTime.now();
