...
---------------------------------------------------------------
Change History:
    2025-07-21: Initial creation - desktop_pet应用程序常量定义;
---------------------------------------------------------------
*/
...
///
/// ```dart
/// DesktopPetUiConstants.spacing.small
/// ```
///
/// ```dart
/// DesktopPetUiConstants.borderRadius.medium
/// ```
///
/// ```dart
/// DesktopPetUiConstants.animationDuration.fast
/// ```
///
class DesktopPetUiConstants {
  /// 私有构造函数，防止实例化
  DesktopPetUiConstants._();
...
class UiFontSize {
  ...
  double get xs => 10;
  double get small => 12;
  double get medium => 14;
  double get large => 16;
  double get xl => 18;
  double get xxl => 20;
  double get title => 24;
  double get heading => 32;
