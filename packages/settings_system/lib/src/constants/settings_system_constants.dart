/*
---------------------------------------------------------------
File name:          settings_system_constants.dart
Author:             Pet App Team
Date created:       2025-07-18
Last modified:      2025-07-18
Dart Version:       3.2+
Description:        settings_system应用程序常量定义
---------------------------------------------------------------
Change History:
    2025-07-18: Initial creation - settings_system应用程序常量定义;
---------------------------------------------------------------
*/

/// settings_system主要常量类
///
/// ## 使用示例
///
/// ```dart
/// SettingsSystemConstants.appName
/// ```
///
/// ```dart
/// SettingsSystemConstants.appVersion
/// ```
///
/// ```dart
/// SettingsSystemConstants.defaultTimeout
/// ```
///
/// ```dart
/// SettingsSystemConstants.maxRetryAttempts
/// ```
///
class SettingsSystemConstants {
  /// 私有构造函数，防止实例化
  SettingsSystemConstants._();

  /// 应用名称
  static const String appName = 'SettingsSystem';
...
/// settings_system应用程序基础常量
///
/// ## 使用示例
///
/// ```dart
/// SettingsSystemAppConstants.appName
/// ```
///
/// ```dart
/// SettingsSystemAppConstants.version
/// ```
///
/// ```dart
/// SettingsSystemAppConstants.buildNumber
/// ```
///
class SettingsSystemAppConstants {
  /// 私有构造函数，防止实例化
  SettingsSystemAppConstants._();
  ...
  /// 应用包名
  static const String packageName = 'com.example.settings_system';
...
/// settings_systemAPI相关常量
///
/// ## 使用示例
///
/// ```dart
/// SettingsSystemApiConstants.baseUrl
/// ```
///
/// ```dart
/// SettingsSystemApiConstants.endpoints.users
/// ```
///
/// ```dart
/// SettingsSystemApiConstants.headers.contentType
/// ```
///
class SettingsSystemApiConstants {
  /// 私有构造函数，防止实例化
  SettingsSystemApiConstants._();
...
class ApiEndpoints {
  ...
  /// settings_system相关端点
  String get settings_systems => '/api/v1/settings_systems';
  String get settings_systemById => '/api/v1/settings_systems/{id}';
...
class ApiHeaders {
  ...
  String get defaultUserAgent => 'SettingsSystem/1.0.0';
...
/// settings_system配置相关常量
///
/// ## 使用示例
///
/// ```dart
/// SettingsSystemConfigConstants.database.name
/// ```
///
/// ```dart
/// SettingsSystemConfigConstants.storage.cacheDir
/// ```
///
/// ```dart
/// SettingsSystemConfigConstants.logging.level
/// ```
///
class SettingsSystemConfigConstants {
  /// 私有构造函数，防止实例化
  SettingsSystemConfigConstants._();
...
class DatabaseConfig {
  ...
  String get name => 'settings_system.db';
  int get version => 1;
...
/// settings_system错误相关常量
///
/// ## 使用示例
///
/// ```dart
/// SettingsSystemErrorConstants.codes.networkError
/// ```
///
/// ```dart
/// SettingsSystemErrorConstants.messages.invalidInput
/// ```
///
/// ```dart
/// SettingsSystemErrorConstants.types.validation
/// ```
///
class SettingsSystemErrorConstants {
  /// 私有构造函数，防止实例化
  SettingsSystemErrorConstants._();
