...
class SyncConfig {
  const SyncConfig({
    ...
    this.conflictResolution = DataSyncConflictStrategy.lastWriteWins,
    this.retryCount = 3,
  ...
  /// 冲突解决策略
  final DataSyncConflictStrategy conflictResolution;
...
class DataSyncManager {
  ...
  Future<List<DataChange>> _resolveConflicts(
    ...
    switch (config.conflictResolution) {
      case DataSyncConflictStrategy.lastWriteWins:
        // 保留最新的变更
        return conflicts;
      case DataSyncConflictStrategy.firstWriteWins:
        // 保留最早的变更
        return conflicts;
      case DataSyncConflictStrategy.manual:
        // 需要手动解决
        return [];
      case DataSyncConflictStrategy.merge:
        // 尝试合并变更
        return conflicts;
    }
  }
