/*
---------------------------------------------------------------
File name:          home_dashboard_constants.dart
Author:             Pet App Team
Date created:       2025-07-18
Last modified:      2025-07-18
Dart Version:       3.2+
Description:        home_dashboard应用程序常量定义
---------------------------------------------------------------
Change History:
    2025-07-18: Initial creation - home_dashboard应用程序常量定义;
---------------------------------------------------------------
*/
...
///
/// ```dart
/// HomeDashboardConstants.appName
/// ```
///
/// ```dart
/// HomeDashboardConstants.appVersion
/// ```
///
/// ```dart
/// HomeDashboardConstants.defaultTimeout
/// ```
///
/// ```dart
/// HomeDashboardConstants.maxRetryAttempts
/// ```
///
class HomeDashboardConstants {
  /// 私有构造函数，防止实例化
  HomeDashboardConstants._();

  /// 应用名称
  static const String appName = 'HomeDashboard';
...
/// home_dashboard应用程序基础常量
///
/// ## 使用示例
///
/// ```dart
/// HomeDashboardAppConstants.appName
/// ```
///
/// ```dart
/// HomeDashboardAppConstants.version
/// ```
///
/// ```dart
/// HomeDashboardAppConstants.buildNumber
/// ```
///
class HomeDashboardAppConstants {
  /// 私有构造函数，防止实例化
  HomeDashboardAppConstants._();
  ...
  /// 应用包名
  static const String packageName = 'com.example.home_dashboard';
...
/// home_dashboardAPI相关常量
///
/// ## 使用示例
///
/// ```dart
/// HomeDashboardApiConstants.baseUrl
/// ```
///
/// ```dart
/// HomeDashboardApiConstants.endpoints.users
/// ```
///
/// ```dart
/// HomeDashboardApiConstants.headers.contentType
/// ```
///
class HomeDashboardApiConstants {
  /// 私有构造函数，防止实例化
  HomeDashboardApiConstants._();
...
class ApiEndpoints {
  ...
  /// home_dashboard相关端点
  String get home_dashboards => '/api/v1/home_dashboards';
  String get home_dashboardById => '/api/v1/home_dashboards/{id}';
...
class ApiHeaders {
  ...
  String get defaultUserAgent => 'HomeDashboard/1.0.0';
...
/// home_dashboard配置相关常量
///
/// ## 使用示例
///
/// ```dart
/// HomeDashboardConfigConstants.database.name
/// ```
///
/// ```dart
/// HomeDashboardConfigConstants.storage.cacheDir
/// ```
///
/// ```dart
/// HomeDashboardConfigConstants.logging.level
/// ```
///
class HomeDashboardConfigConstants {
  /// 私有构造函数，防止实例化
  HomeDashboardConfigConstants._();
...
class DatabaseConfig {
  ...
  String get name => 'home_dashboard.db';
  int get version => 1;
...
/// home_dashboard错误相关常量
///
/// ## 使用示例
///
/// ```dart
/// HomeDashboardErrorConstants.codes.networkError
/// ```
///
/// ```dart
/// HomeDashboardErrorConstants.messages.invalidInput
/// ```
///
/// ```dart
/// HomeDashboardErrorConstants.types.validation
/// ```
///
class HomeDashboardErrorConstants {
  /// 私有构造函数，防止实例化
  HomeDashboardErrorConstants._();
