/*
---------------------------------------------------------------
File name:          creative_workshop_utils.dart
Author:             Pet App Team
Date created:       2025-07-18
Last modified:      2025-07-18
Dart Version:       3.2+
Description:        creative_workshop工具类和辅助函数
---------------------------------------------------------------
Change History:
    2025-07-18: Initial creation - creative_workshop工具类和辅助函数;
---------------------------------------------------------------
*/
...
///
/// ```dart
/// CreativeWorkshopUtils.isValidEmail("test@example.com")
/// ```
///
/// ```dart
/// CreativeWorkshopUtils.isValidPassword("password123")
/// ```
///
/// ```dart
/// CreativeWorkshopUtils.formatToTitleCase("hello world")
/// ```
///
/// ```dart
/// CreativeWorkshopUtils.formatDateTime(DateTime.now())
/// ```
///
class CreativeWorkshopUtils {
  /// 私有构造函数，防止实例化
  CreativeWorkshopUtils._();
...
///
/// ```dart
/// CreativeWorkshopValidator.isValidEmail("test@example.com")
/// ```
///
/// ```dart
/// CreativeWorkshopValidator.isValidPassword("password123")
/// ```
///
/// ```dart
/// CreativeWorkshopValidator.validateRequired("value", "字段名")
/// ```
///
class CreativeWorkshopValidator {
  /// 私有构造函数，防止实例化
  CreativeWorkshopValidator._();
...
/// creative_workshop数据格式化器
///
/// ## 使用示例
///
/// ```dart
/// CreativeWorkshopFormatter.formatDate(DateTime.now())
/// ```
///
/// ```dart
/// CreativeWorkshopFormatter.formatFileSize(1024)
/// ```
///
/// ```dart
/// CreativeWorkshopFormatter.formatCurrency(99.99)
/// ```
///
class CreativeWorkshopFormatter {
  /// 私有构造函数，防止实例化
  CreativeWorkshopFormatter._();
...
/// creative_workshop辅助函数集合
///
/// ## 使用示例
///
/// ```dart
/// CreativeWorkshopHelper.generateId()
/// ```
///
/// ```dart
/// CreativeWorkshopHelper.debounce(() => print("执行"), Duration(seconds: 1))
/// ```
///
/// ```dart
/// CreativeWorkshopHelper.retry(() async => await someOperation(), maxAttempts: 3)
/// ```
///
class CreativeWorkshopHelper {
  /// 私有构造函数，防止实例化
  CreativeWorkshopHelper._();
...
/// String扩展方法
extension CreativeWorkshopStringExtension on String {
  /// 首字母大写
  ...
  String get toCamelCase {
    ...
    final rest = words.skip(1).map((String word) => word.capitalize);
...
/// DateTime扩展方法
extension CreativeWorkshopDateTimeExtension on DateTime {
  /// 是否为今天
  bool get isToday {
    final now = DateTime.now();
