/*
---------------------------------------------------------------
File name:          creative_workshop_constants.dart
Author:             Pet App Team
Date created:       2025-07-18
Last modified:      2025-07-18
Dart Version:       3.2+
Description:        creative_workshop应用程序常量定义
---------------------------------------------------------------
Change History:
    2025-07-18: Initial creation - creative_workshop应用程序常量定义;
---------------------------------------------------------------
*/

/// creative_workshop主要常量类
///
/// ## 使用示例
///
/// ```dart
/// CreativeWorkshopConstants.appName
/// ```
///
/// ```dart
/// CreativeWorkshopConstants.appVersion
/// ```
///
/// ```dart
/// CreativeWorkshopConstants.defaultTimeout
/// ```
///
/// ```dart
/// CreativeWorkshopConstants.maxRetryAttempts
/// ```
///
class CreativeWorkshopConstants {
  /// 私有构造函数，防止实例化
  CreativeWorkshopConstants._();

  /// 应用名称
  static const String appName = 'CreativeWorkshop';
  ...
  /// 支持的语言
  static const List<String> supportedLanguages = <String>['en', 'zh'];
...
/// creative_workshop应用程序基础常量
///
/// ## 使用示例
///
/// ```dart
/// CreativeWorkshopAppConstants.appName
/// ```
///
/// ```dart
/// CreativeWorkshopAppConstants.version
/// ```
///
/// ```dart
/// CreativeWorkshopAppConstants.buildNumber
/// ```
///
class CreativeWorkshopAppConstants {
  /// 私有构造函数，防止实例化
  CreativeWorkshopAppConstants._();
  ...
  /// 应用包名
  static const String packageName = 'com.example.creative_workshop';
...
/// creative_workshopAPI相关常量
///
/// ## 使用示例
///
/// ```dart
/// CreativeWorkshopApiConstants.baseUrl
/// ```
///
/// ```dart
/// CreativeWorkshopApiConstants.endpoints.users
/// ```
///
/// ```dart
/// CreativeWorkshopApiConstants.headers.contentType
/// ```
///
class CreativeWorkshopApiConstants {
  /// 私有构造函数，防止实例化
  CreativeWorkshopApiConstants._();
...
class ApiEndpoints {
  ...
  /// creative_workshop相关端点
  String get creative_workshops => '/api/v1/creative_workshops';
  String get creative_workshopById => '/api/v1/creative_workshops/{id}';
...
class ApiHeaders {
  ...
  String get defaultUserAgent => 'CreativeWorkshop/1.0.0';
...
/// creative_workshop配置相关常量
///
/// ## 使用示例
///
/// ```dart
/// CreativeWorkshopConfigConstants.database.name
/// ```
///
/// ```dart
/// CreativeWorkshopConfigConstants.storage.cacheDir
/// ```
///
/// ```dart
/// CreativeWorkshopConfigConstants.logging.level
/// ```
///
class CreativeWorkshopConfigConstants {
  /// 私有构造函数，防止实例化
  CreativeWorkshopConfigConstants._();
...
class DatabaseConfig {
  ...
  String get name => 'creative_workshop.db';
  int get version => 1;
...
/// creative_workshop错误相关常量
///
/// ## 使用示例
///
/// ```dart
/// CreativeWorkshopErrorConstants.codes.networkError
/// ```
///
/// ```dart
/// CreativeWorkshopErrorConstants.messages.invalidInput
/// ```
///
/// ```dart
/// CreativeWorkshopErrorConstants.types.validation
/// ```
///
class CreativeWorkshopErrorConstants {
  /// 私有构造函数，防止实例化
  CreativeWorkshopErrorConstants._();
