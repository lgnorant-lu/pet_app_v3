/*
---------------------------------------------------------------
File name:          theme_system_constants.dart
Author:             Pet App Team
Date created:       2025-07-18
Last modified:      2025-07-18
Dart Version:       3.2+
Description:        theme_system应用程序常量定义
---------------------------------------------------------------
Change History:
    2025-07-18: Initial creation - theme_system应用程序常量定义;
---------------------------------------------------------------
*/
...
///
/// ```dart
/// ThemeSystemConstants.appName
/// ```
///
/// ```dart
/// ThemeSystemConstants.appVersion
/// ```
///
/// ```dart
/// ThemeSystemConstants.defaultTimeout
/// ```
///
/// ```dart
/// ThemeSystemConstants.maxRetryAttempts
/// ```
///
class ThemeSystemConstants {
  /// 私有构造函数，防止实例化
  ThemeSystemConstants._();

  /// 应用名称
  static const String appName = 'ThemeSystem';
...
/// theme_system应用程序基础常量
///
/// ## 使用示例
///
/// ```dart
/// ThemeSystemAppConstants.appName
/// ```
///
/// ```dart
/// ThemeSystemAppConstants.version
/// ```
///
/// ```dart
/// ThemeSystemAppConstants.buildNumber
/// ```
///
class ThemeSystemAppConstants {
  /// 私有构造函数，防止实例化
  ThemeSystemAppConstants._();
  ...
  /// 应用包名
  static const String packageName = 'com.example.theme_system';
...
///
/// ```dart
/// ThemeSystemApiConstants.baseUrl
/// ```
///
/// ```dart
/// ThemeSystemApiConstants.endpoints.users
/// ```
///
/// ```dart
/// ThemeSystemApiConstants.headers.contentType
/// ```
///
class ThemeSystemApiConstants {
  /// 私有构造函数，防止实例化
  ThemeSystemApiConstants._();
...
class ApiEndpoints {
  ...
  /// theme_system相关端点
  String get theme_systems => '/api/v1/theme_systems';
  String get theme_systemById => '/api/v1/theme_systems/{id}';
...
class ApiHeaders {
  ...
  String get defaultUserAgent => 'ThemeSystem/1.0.0';
...
///
/// ```dart
/// ThemeSystemConfigConstants.database.name
/// ```
///
/// ```dart
/// ThemeSystemConfigConstants.storage.cacheDir
/// ```
///
/// ```dart
/// ThemeSystemConfigConstants.logging.level
/// ```
///
class ThemeSystemConfigConstants {
  /// 私有构造函数，防止实例化
  ThemeSystemConfigConstants._();
...
class DatabaseConfig {
  ...
  String get name => 'theme_system.db';
  int get version => 1;
...
///
/// ```dart
/// ThemeSystemErrorConstants.codes.networkError
/// ```
///
/// ```dart
/// ThemeSystemErrorConstants.messages.invalidInput
/// ```
///
/// ```dart
/// ThemeSystemErrorConstants.types.validation
/// ```
///
class ThemeSystemErrorConstants {
  /// 私有构造函数，防止实例化
  ThemeSystemErrorConstants._();
