/*
---------------------------------------------------------------
File name:          theme_system_utils.dart
Author:             Pet App Team
Date created:       2025-07-18
Last modified:      2025-07-18
Dart Version:       3.2+
Description:        theme_system工具类和辅助函数
---------------------------------------------------------------
Change History:
    2025-07-18: Initial creation - theme_system工具类和辅助函数;
---------------------------------------------------------------
*/
...
///
/// ```dart
/// ThemeSystemUtils.isValidEmail("test@example.com")
/// ```
///
/// ```dart
/// ThemeSystemUtils.isValidPassword("password123")
/// ```
///
/// ```dart
/// ThemeSystemUtils.formatToTitleCase("hello world")
/// ```
///
/// ```dart
/// ThemeSystemUtils.formatDateTime(DateTime.now())
/// ```
///
...
///
/// ```dart
/// ThemeSystemValidator.isValidEmail("test@example.com")
/// ```
///
/// ```dart
/// ThemeSystemValidator.isValidPassword("password123")
/// ```
///
/// ```dart
/// ThemeSystemValidator.validateRequired("value", "字段名")
/// ```
///
class ThemeSystemValidator {
  /// 私有构造函数，防止实例化
  ThemeSystemValidator._();
...
///
/// ```dart
/// ThemeSystemFormatter.formatDate(DateTime.now())
/// ```
///
/// ```dart
/// ThemeSystemFormatter.formatFileSize(1024)
/// ```
///
/// ```dart
/// ThemeSystemFormatter.formatCurrency(99.99)
/// ```
///
class ThemeSystemFormatter {
  /// 私有构造函数，防止实例化
  ThemeSystemFormatter._();
...
///
/// ```dart
/// ThemeSystemHelper.generateId()
/// ```
///
/// ```dart
/// ThemeSystemHelper.debounce(() => print("执行"), Duration(seconds: 1))
/// ```
///
/// ```dart
/// ThemeSystemHelper.retry(() async => await someOperation(), maxAttempts: 3)
/// ```
///
...
/// String扩展方法
extension ThemeSystemStringExtension on String {
  /// 首字母大写
...
/// DateTime扩展方法
extension ThemeSystemDateTimeExtension on DateTime {
  /// 是否为今天
  bool get isToday {
    final now = DateTime.now();
