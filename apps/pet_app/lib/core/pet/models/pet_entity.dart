...
class PetEntity {
  ...
  factory PetEntity.createDefault({
    ...
    final id = 'pet_${now.millisecondsSinceEpoch}';
  ...
  int get overallScore {
    return ((health + energy + (100 - hunger) + happiness + cleanliness) / 5).round();
  }
  ...
  @override
  String toString() => 'PetEntity(id: $id, name: $name, status: $status, mood: $mood)';
}
