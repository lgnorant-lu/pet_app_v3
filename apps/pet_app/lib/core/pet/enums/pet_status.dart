...
enum PetStatus {
  ...
  /// 从ID获取状态
  static PetStatus fromId(String id) {
  ...
  /// 获取生命周期状态
  static List<PetStatus> get lifecycleStatuses => [
    PetStatus.unborn,
    PetStatus.hatching,
    PetStatus.baby,
    PetStatus.growing,
  ...
  /// 获取健康状态
  static List<PetStatus> get healthStatuses => [
    PetStatus.healthy,
    PetStatus.active,
    PetStatus.tired,
    PetStatus.weak,
  ...
  /// 获取系统状态
  static List<PetStatus> get systemStatuses => [
    PetStatus.offline,
